...
namespace Core
{
    ...
    public static class WalExtensions
    {
        ...
        internal static RC Read(this Wal a, Pid w, ref int x, int y, byte[] z) { return 0; }
        internal static Pid DBSize(this Wal a) { return 0; }
        ...
        internal static RC Frames(this Wal a, int v, PgHdr w, Pid x, int y, int z) { return 0; }
